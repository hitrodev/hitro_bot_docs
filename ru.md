...
Средняя доходность за месяц **+30-50%**. Тестирование алгоритма на исторических данных (backtesting) показывает положительный результат в конце каждого месяца. Результаты бэктестинга доступны [здесь](/backtesting/report.md).
