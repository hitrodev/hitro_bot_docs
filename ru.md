...
Его название вытекает от словосочетания "хитрая стратегия, алгоритм".
...
2. Бот попросит прислать ему приглашение. Отправь ему в сообщении свое приглашение или свяжись с разработчиками [@hitro_dev](https://t.me/hitro_dev), если его нет.
...
Например, процент комиссии 30%, и за две недели робот поднял с $1000 до $1200. Прибыль составляет `$1200 - $1000 = $200`.  
